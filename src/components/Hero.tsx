        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            <motion.div
              ...
              className="mb-4"
            >
              <span className="inline-block px-4 py-2 rounded-full glass text-sm font-medium text-indigo-400">
                Full Stack Engineer
              </span>
            </motion.div>
            ...
            >
              Hi, I'm{" "}
              <span className="gradient-text">Eran Yosef</span>
            </motion.h1>
            ...
            >
              ...
              Passionate about creating responsive, scalable solutions with clean code
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-semibold shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50 transition-shadow"
              >
                View My Work
              </motion.a>
              <motion.a
